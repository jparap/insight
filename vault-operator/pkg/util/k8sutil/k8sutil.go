...
//NewSecret create new secrets in namespace
func NewSecret(vr *api.VaultService, secretName, keyName string, keyValue []byte) *v1.Secret {
	return &v1.Secret{
		ObjectMeta: metav1.ObjectMeta{
			Name:   fmt.Sprintf("%s-%s", vr.Name, secretName),
